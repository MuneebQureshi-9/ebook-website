<section class="section-block container hero-section">
    <div class="section-heading reveal" data-reveal>
        <p class="section-kicker">Book Writing</p>
        <h1>Turn Your Idea Into a Book That Readers Can't Put Down</h1>
        <p class="hero-section__text" style="max-width: 800px;">Our experienced ghostwriters sit down with you and interview you extensively to understand your ideas, your story, and the angles that you want both to be written from. Then, we do all of the hard work for you, letting you collect the royalty checks at the end.</p>
        <div class="hero-section__actions">
            @include('components.cta-button', ['href' => route('contact', ['service' => 'book-writing']), 'label' => 'Request a Quote'])
            @include('components.cta-button', ['href' => route('contact', ['service' => 'book-writing']), 'label' => 'Consult with an Expert', 'variant' => 'secondary'])
        </div>
    </div>
</section>
...
<section class="section-block container">
    ...
    <div class="grid grid--three">
        <article class="surface-card reveal" data-reveal>
            ...
            <p>Full book writing from concept to final manuscript</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">02</span>
            <p>In-depth research and expert structuring</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">03</span>
            <p>Multiple rounds of editing and refinement</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">04</span>
            <p>Industry-standard formatting for publishing</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">05</span>
            <p>Your name on the cover, 100% ghostwritten, fully confidential</p>
        </article>
    </div>
</section>
