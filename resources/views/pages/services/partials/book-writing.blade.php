<section class="section-block" style="padding-top: 3.5rem; padding-bottom: 2.5rem; background: var(--color-bg); position: relative; overflow: hidden; margin-top: -76px; padding-top: calc(76px + 3.5rem) !important;">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div class="section-heading reveal" data-reveal style="max-width: 100%; text-align: center; margin-bottom: 0;">
            <!-- Kicker Badge -->
            <p class="section-kicker" style="margin: 0 auto 1.25rem; display: inline-flex;">Book Writing</p>
            ...
            <p style="font-size: 1.25rem; color: var(--color-primary); font-weight: 600; line-height: 1.4; max-width: 700px; margin: 0 auto 1rem;">
                Monetize Your Ideas With Our Book Writing Services
            </p>
            
            <!-- Description -->
            <p style="font-size: 1.1rem; color: var(--color-muted); line-height: 1.75; max-width: 720px; margin: 0 auto 2.5rem;">
                You have the ideas, and we have the skills. This combo can bring you visibility, money and leads. Our expert ghostwriters turn your brilliant ideas into useful books with your name on the cover. That translates into real money in your pocket in a short time.
            </p>
            
            <!-- CTA Buttons -->
            <div style="display: flex; flex-wrap: wrap; gap: 1rem; justify-content: center; margin-bottom: 2.5rem;">
                @include('components.cta-button', ['href' => route('contact', ['service' => 'book-writing']), 'label' => 'Get a Free Quote'])
                @include('components.cta-button', ['href' => route('contact', ['service' => 'book-writing']), 'label' => 'Speak to a Writing Expert', 'variant' => 'secondary'])
            </div>
...
<section class="section-block container">
    <div class="section-heading reveal" data-reveal style="margin-bottom: 3rem;">
        <h2>WHAT'S INCLUDED IN OUR BOOK WRITING SERVICES:</h2>
    </div>
    <div class="grid grid--three">
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">01</span>
            <p>A complete manuscript written in your voice</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">02</span>
            <p>Thorough research and complete detailing</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">03</span>
            <p>Multiple editing passes to sharpen</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">04</span>
            <p>Print and digital formatting to meet industry standards</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">05</span>
            <p>Full confidentiality for printing and marketing.</p>
        </article>
    </div>
</section>
