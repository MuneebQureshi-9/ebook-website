<section class="section-block" style="padding-top: 3.5rem; padding-bottom: 2.5rem; background: var(--color-bg); position: relative; overflow: hidden; margin-top: -76px; padding-top: calc(76px + 3.5rem) !important;">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div class="section-heading reveal" data-reveal style="max-width: 100%; text-align: center; margin-bottom: 0;">
            <!-- Kicker Badge -->
            <p class="section-kicker" style="margin: 0 auto 1.25rem; display: inline-flex;">Cover Design</p>
            ...
            <p style="font-size: 1.25rem; color: var(--color-primary); font-weight: 600; line-height: 1.4; max-width: 700px; margin: 0 auto 1rem;">
                Covers That Make Browsers Stop Scrolling
            </p>
            
            <!-- Description -->
            <p style="font-size: 1.1rem; color: var(--color-muted); line-height: 1.75; max-width: 720px; margin: 0 auto 2.5rem;">
                Your cover competes in a crowded marketplace where readers make split-second decisions. Therefore, it needs an excellent genre to be high-quality and authoritative. Our design team creates covers that help your books perform in Amazon search results, social media feeds, and storefronts worldwide.
            </p>
...
<section class="section-block container">
    ...
    <div class="grid grid--three">
        <article class="surface-card reveal" data-reveal>
            ...
            <p>Custom and genre-specific cover concepts</p>
        </article>
        <article class="surface-card reveal" data-reveal>
        ...
        <article class="surface-card reveal" data-reveal>
            ...
            <p>Attractive typography</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">04</span>
            <p>Extensive market research to outperform competitors</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">05</span>
            <p>3D mockups for online marketing and coverage</p>
        </article>
    </div>
</section>
