<section class="section-block container hero-section">
    <div class="section-heading reveal" data-reveal>
        <p class="section-kicker">Cover Design</p>
        <h1>Get Scroll-Stopping Covers for Attention</h1>
        <p class="hero-section__text" style="max-width: 800px;">Your cover is your first impression, and it needs to make an immediate impact. A well-designed cover instantly conveys the genre, the tone, and the professionalism of your book. Our design team focuses on creating covers that don't just look beautiful, but are specifically engineered to grab attention in crowded online marketplaces and convert browsers into buyers.</p>
        <div class="hero-section__actions">
            @include('components.cta-button', ['href' => route('contact', ['service' => 'cover-design']), 'label' => 'Request a Quote'])
            @include('components.cta-button', ['href' => route('contact', ['service' => 'cover-design']), 'label' => 'View Portfolio', 'variant' => 'secondary'])
        </div>
    </div>
</section>
...
<section class="section-block container">
    ...
    <div class="grid grid--three">
        <article class="surface-card reveal" data-reveal>
            ...
            <p>Custom, genre-specific cover design concepts</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">02</span>
            <p>High-resolution front, spine, and back cover layouts</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">03</span>
            <p>Typography optimization for thumbnail readability</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">04</span>
            <p>Extensive market research to beat competitors</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">05</span>
            <p>3D mockups for marketing and social media promotion</p>
        </article>
    </div>
</section>
