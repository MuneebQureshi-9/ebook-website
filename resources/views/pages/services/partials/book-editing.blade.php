<section class="section-block container hero-section">
    <div class="section-heading reveal" data-reveal>
        <p class="section-kicker">Book Editing</p>
        <h1>Polish Your Manuscript to Perfection</h1>
        <p class="hero-section__text" style="max-width: 800px;">What if your book fails to convey what you want due to
            grammar and spelling errors and unstructured messages? Our professional team of experts helps you by
            combining editorial precision with the creation of a book that grabs the reader's attention and is
            remembered.</p>
...
<section class="section-block container">
    <div class="section-heading reveal" data-reveal style="margin-bottom: 3rem;">
        <h2>EDITING INCLUDES:</h2>
    </div>
    <div class="grid grid--two">
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">01</span>
            <p>Developmental editing (structure, pacing, flow)</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">02</span>
            <p>Line editing and sentence-level refinement</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">03</span>
            <p>Grammar, punctuation, and consistency correction</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">04</span>
            <p>Proofreading for final publication readiness</p>
        </article>
    </div>
</section>
