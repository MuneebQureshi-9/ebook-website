<section class="section-block" style="padding-top: 3.5rem; padding-bottom: 2.5rem; background: var(--color-bg); position: relative; overflow: hidden; margin-top: -76px; padding-top: calc(76px + 3.5rem) !important;">
    ...
    <div class="container" style="position: relative; z-index: 1;">
        <div class="section-heading reveal" data-reveal style="max-width: 100%; text-align: center; margin-bottom: 0;">
            <!-- Kicker Badge -->
            <p class="section-kicker" style="margin: 0 auto 1.25rem; display: inline-flex;">Book Editing</p>
            ...
            <p style="font-size: 1.25rem; color: var(--color-primary); font-weight: 600; line-height: 1.4; max-width: 700px; margin: 0 auto 1rem;">
                Editing That Gives Your Book a New Look
            </p>
            
            <!-- Description -->
            <p style="font-size: 1.1rem; color: var(--color-muted); line-height: 1.75; max-width: 720px; margin: 0 auto 2.5rem;">
                Book writing is just the first part. Editing gives it real shape. Great ideas get buried under weak sentences every day. We don’t just offer standard editing; our editors shape your book’s structure, pacing, clarity, and consistency to make it worth reading.
            </p>
            
            <!-- CTA Buttons -->
            <div style="display: flex; flex-wrap: wrap; gap: 1rem; justify-content: center; margin-bottom: 2.5rem;">
                @include('components.cta-button', ['href' => route('contact', ['service' => 'book-editing']), 'label' => 'Request a Quote'])
                @include('components.cta-button', ['href' => route('contact', ['service' => 'book-editing']), 'label' => 'Talk with an Expert', 'variant' => 'secondary'])
            </div>
...
<section class="section-block container">
    <div class="section-heading reveal" data-reveal style="margin-bottom: 3rem;">
        <h2>OUR BOOK EDITING SERVICES INCLUDE:</h2>
    </div>
    <div class="grid grid--two">
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">01</span>
            <p>Fixing structure, pacing, and narrative flow to shape the book.</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">02</span>
            <p>Line-by-line editing to tighten every sentence</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">03</span>
            <p>Grammar, punctuation, and style consistency across all of your pages</p>
        </article>
        <article class="surface-card reveal" data-reveal>
            <span class="step-number">04</span>
            <p>A final proofread that detects and fixes all errors</p>
        </article>
    </div>
</section>
        ...
        ">
            ...
            <div style="position: relative; z-index: 1; max-width: 680px; margin: 0 auto; text-align: center;">
                ...
                <p
                    ...
                    Book a free 30-minute strategy call and we'll map out exactly how to take your idea from concept to
                    bestseller.
                </p>
                <div style="display: flex; flex-wrap: wrap; gap: 1rem; justify-content: center;">
                    <a href="{{ route('contact') }}" class="action-button"
                        style="background: #ffffff; color: #1e3a8a; box-shadow: 0 14px 30px rgba(15,23,42,0.25); font-weight: 800;"
                    ...
                    <a href="{{ route('services.index') }}" class="action-button"
                        style="background: rgba(255,255,255,0.08); border: 1px solid rgba(255,255,255,0.22); color: rgba(255,255,255,0.9); font-weight: 700;"
                ...
                <div style="display: flex; flex-wrap: wrap; gap: 0.75rem; justify-content: center; margin-top: 2rem;">
                    @foreach (['No commitment required', 'Free 30-min call', 'Results-driven approach'] as $badge)
                        <span
                            style="display: inline-flex; align-items: center; gap: 0.4rem; color: rgba(255,255,255,0.55); font-size: 0.8rem; font-weight: 500;">
